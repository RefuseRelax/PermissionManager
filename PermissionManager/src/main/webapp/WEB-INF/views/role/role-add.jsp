...
<body data-type="widgets">
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-line-form" id="roleAdd" action="/role?op=execAdd" method="post">
                               	    <input type="hidden" id="id" name="id" value="${role.id}">
                                    <div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">角色名称 <span class="tpl-form-line-small-title">名称</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="rname" name="rname" placeholder="请输入角色名称">
                                            <small>请填写角色名称。</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="rcode" name="rcode" placeholder="请输入角色代码">
                                     ...
                                     <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <textarea class="" rows="10" name="description" id="description" placeholder="请输入角色描述" ></textarea>
                                        </div>
                                    </div>
    ...
    <i class="am-icon-cloud-upload"></i> 添加封面图片</button>
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-u-sm-9 am-u-sm-push-3">
                                            <button  id="submit"   class="am-btn am-btn-primary tpl-btn-bg-color-success ">提交</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
	...
	<script type="text/javascript">
		/**function sendMsg(){
			...
			var name = $("#rname").val();
			websocket.send("你好，新增一个名为 "+name+" 的角色");
			$("#roleAdd").submit();
