                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-line-form" action="/role?op=execUpdate" method="post">
                               	    <input type="hidden" id="id" name="id" value="${role.id}">
                                    <div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">角色名称 <span class="tpl-form-line-small-title">名称</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="user-name" name="rname" placeholder="请输入角色名称" value="${role.rname}">
                                            <small>请填写角色名称。</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="user-name" name="rcode" placeholder="请输入角色代码" value="${role.rcode}" readonly="readonly">
                                     ...
                                     <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <textarea class="" rows="10" name="description" id="user-intro" placeholder="请输入角色描述" >${role.rdescription}</textarea>
                                        </div>
                                    </div>
