...
<body data-type="widgets">
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-line-form" id="perAdd" action="/permission?op=execAdd" method="post">
                                    <div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">权限名称 <span class="tpl-form-line-small-title">名称</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="pname" name="pname" placeholder="请输入权限名称">
                                            <small>请填写权限名称。</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="pcode" name="pcode" placeholder="请输入权限代码" onchange="">
                                     ...
                                     <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="url" name="url" placeholder="请输入权限路径">
                                            <small>请填写权限路径。</small>
                                        </div>
                                    </div>
                                    ...
                                    <input type="hidden" name="isMenu" id="isMenu" value="0">
                                     ...
                                     <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <textarea class="" rows="10" name="description" id="description" placeholder="请输入权限描述" ></textarea>
                                        </div>
                                    </div>
    ...
    <script>
    	$("#submi").click(function(){
    		...
    		var name = $("#pname").val();
    		websocket.send("新增一条名为："+name+" 的权限");
    		$("#perAdd").submit();
